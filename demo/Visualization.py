#Plots of the Right GCT and vertical accelerometer signal for treadmill walking, treadmill jogging, overground walking, and overground jogging
#Sailee Sansgiri 2024
...
#plot titles
titles = {
    'sample_treadmill_walk': 'Treadmill Walking',
    'sample_treadmill_jog': 'Treadmill Jogging',
    'sample_overground_walk': 'Overground Walking',
    'sample_overground_jog': 'Overground Jogging'
}

# Sampling frequency of IMUs and insoles=100 Hz
fs = 100
